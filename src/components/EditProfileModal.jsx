...
export const EditProfileModal = ({ isOpen, onClose, onUpdate }) => {
    const { user } = useAuth();
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (onUpdate) onUpdate(result.usuario || result.user || result);
            onClose();
        } catch (error) {
                ...
                <form onSubmit={handleSubmit} className="p-5 space-y-5" encType="multipart/form-data">
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            onChange={handleChange}
                            maxLength={500}
                            className="w-full px-4 py-3 bg-gray-800/50 border border-gray-700 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 transition-all resize-none h-20"
                        />
